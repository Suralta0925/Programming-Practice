function generateUniqueDigitLottoNumbers(count: number): string[] {
    const generated: Set<string> = new Set();         // Final numbers
    const rumbleForms: Set<string> = new Set();       // Prevent permutations
